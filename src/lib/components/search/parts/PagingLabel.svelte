...
{#if !isBottom || !isLoading}
    <div class="flex max-w-xl">      
        <button class="hover:bg-stone-300 rounded" type="button" on:click={clickBackward} title="前へ" disabled={isLoading}>
        ...
        <button class="hover:bg-stone-300 rounded" type="button" on:click={clickForward} title="次へ" disabled={isLoading}>
