...
} from '$lib/GoogleBooksAPI/RequestManage';
...
export const load = (async (params) => {
	...
	if (query) {
		searchType = 'fuzzy';
		requestBookInfo = async () =>
			requestBookInfoByFuzzySearch(query!, maxResults, startIndex) as books_v1.Schema$Volumes;
	...
	return {
		requestBookInfo,
		props: { searchType, query, bookTitle, author, isbn, page, startIndex }
	};
}) satisfies PageLoad;
